/**
 * Variant C — LIGHT background, TEXT ONLY (no photo)
 * Use for: slides 3, 4, 7 (alternating with D)
 */
import { renderWithHighlight } from './A.jsx';

export default function VariantC({ slide, brand }) {
